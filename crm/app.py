...
RESOURCES_LIST = [
    ...
    {"slug": "hospitality_cold_call_masterclass",
     ...
     "subtitle": "Hotels, Airbnbs & rental apartments — full-stack guide with tones + technical depth"},
    {"slug": "hospitality_cold_call_masterclass_gr",
     "title": "🏨 Cold Call Masterclass Τουρισμού (GR)",
     "subtitle": "Ξενοδοχεία, Airbnb & ενοικιαζόμενα διαμερίσματα — πλήρης οδηγός με τόνους + τεχνική γνώση"},
